...
import { getProject, approveProjectInvite, denyProjectInvite } from '@cm/api/project'
...
import { Project, Profile } from '@cm/types/project'
        ...
        <div className="flex justify-center items-center p-4 bg-muted h-full">
          <Card className="max-w-md w-full">
            <CardContent className="py-8">
              <div className="text-center text-gray-500">초대장을 불러오는 중...</div>
            </CardContent>
          </Card>
        </div>
      </div>
              ...
              <div className="flex items-center gap-3 p-3 bg-cm-light/40 rounded-lg">
                ...
                <div className="flex-1">
                  <div className="text-sm text-primary mb-2">
                    <span className="font-medium">현재 {activeMembers.length}명의 팀원이 함께하고 있습니다</span>
                  </div>
                  <AvatarGroup
